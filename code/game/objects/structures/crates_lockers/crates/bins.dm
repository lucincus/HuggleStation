...
/obj/structure/closet/crate/diaperpail
	desc = "A pail for dumping used diapers and other things in."
	name = "diaper pail"
	icon = 'icons/incon/furniture.dmi'
	icon_state = "diaperpail"
	open_sound = 'sound/effects/bin_open.ogg'
	close_sound = 'sound/effects/bin_close.ogg'
...
/obj/structure/closet/crate/diaperpail/New()
	..()
	update_icon()

/obj/structure/closet/crate/diaperpail/attackby(obj/item/W, mob/user, params)
	if(istype(W, /obj/item/storage/bag/trash))
		var/obj/item/storage/bag/trash/T = W
		to_chat(user, "<span class='notice'>You fill the bag.</span>")
		for(var/obj/item/O in src)
...
/obj/structure/closet/crate/diaperpail/proc/do_animate()
	playsound(loc, open_sound, 15, 1, -3)
	spawn(13)
		playsound(loc, close_sound, 15, 1, -3)
		update_icon()
