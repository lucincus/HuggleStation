...
/datum/game_mode/traitor
	...
	restricted_jobs = list("Prisoner", "Cyborg", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel") //Cyborgs are part of the AI, if it is traitor so are they; they used to get double chances
