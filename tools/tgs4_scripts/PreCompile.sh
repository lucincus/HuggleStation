...
echo "Compiling tgui..."
cd "$1"
chmod +x ../HuggleStation/tools/bootstrap/node  # Workaround for https://github.com/tgstation/tgstation-server/issues/1167
env TG_BOOTSTRAP_CACHE="$original_dir" TG_BOOTSTRAP_NODE_LINUX=1 CBT_BUILD_MODE="TGS" ../HuggleStation/tools/bootstrap/node ../HuggleStation/tools/build/build.js
